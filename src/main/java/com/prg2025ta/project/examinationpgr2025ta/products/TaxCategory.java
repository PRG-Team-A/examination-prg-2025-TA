...
/**
 * Tax categories used to map product types to tax rates.
 * Rates are example defaults and can be adjusted if needed.
 */
public enum TaxCategory {
    ...
    /**
     * @return tax rate as fraction (e.g. 0.21 for 21%)
     */
